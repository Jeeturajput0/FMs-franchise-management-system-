...
export const NAVIGATION_CONFIG = {
    ...
    { label: "Overview", icon: "grid", path: "/dashboard/coaching-admin" },
    {
      ...
      children: [
        { label: "All Students", path: "/dashboard/coaching-admin/students" },
        {
          ...
          path: "/dashboard/coaching-admin/students/1",
        },
      ],
    },
    {
      ...
      children: [
        { label: "All Teachers", path: "/dashboard/coaching-admin/teachers" },
        {
          ...
          path: "/dashboard/coaching-admin/teachers/1",
        },
      ],
    },
    {
      label: "Courses",
      icon: "book",
      path: "/dashboard/coaching-admin/courses",
    },
    {
      label: "Batches",
      icon: "layers",
      ...
      children: [
        ...
        {
          label: "Batch Details",
          path: "/dashboard/coaching-admin/batches/101",
        },
      ],
    },
    {
      label: "Attendance",
      icon: "calendar",
      path: "/dashboard/coaching-admin/attendance",
    },
    { label: "Fees", icon: "wallet", path: "/dashboard/coaching-admin/fees" },
    {
      label: "Exams",
      icon: "fileText",
      path: "/dashboard/coaching-admin/exams",
    },
    {
      label: "Results",
      icon: "chart",
      path: "/dashboard/coaching-admin/results",
    },
    {
      label: "Certificates",
      icon: "award",
      path: "/dashboard/coaching-admin/certificates",
    },
    {
      label: "Notifications",
      icon: "bell",
      path: "/dashboard/coaching-admin/notifications",
      badge: "3",
    },
    {
      label: "Reports",
      icon: "barChart",
      path: "/dashboard/coaching-admin/reports",
    },
    {
      label: "Settings",
      icon: "settings",
      path: "/dashboard/coaching-admin/settings",
    },
  ],
  ...
  [ROLES.FRANCHISE_OWNER]: [
    { label: "Overview", icon: "grid", path: "/dashboard/franchise-owner" },
    {
      label: "Admissions",
      icon: "userPlus",
      path: "/dashboard/franchise-owner/admissions",
    },
    {
      label: "Students",
      icon: "users",
      path: "/dashboard/franchise-owner/students",
    },
    {
      label: "Teachers",
      icon: "userCheck",
      path: "/dashboard/franchise-owner/teachers",
    },
    {
      label: "Courses",
      icon: "book",
      path: "/dashboard/franchise-owner/courses",
    },
    {
      label: "Batches",
      icon: "layers",
      path: "/dashboard/franchise-owner/batches",
    },
    {
      label: "Attendance",
      icon: "calendar",
      path: "/dashboard/franchise-owner/attendance",
    },
    { label: "Fees", icon: "wallet", path: "/dashboard/franchise-owner/fees" },
    {
      label: "Certificates",
      icon: "award",
      path: "/dashboard/franchise-owner/certificates",
    },
    {
      label: "Staff",
      icon: "shield",
      path: "/dashboard/franchise-owner/staff",
    },
    {
      label: "Expenses",
      icon: "trendingDown",
      path: "/dashboard/franchise-owner/expenses",
    },
    {
      label: "Revenue",
      icon: "dollar",
      path: "/dashboard/franchise-owner/revenue",
    },
    {
      label: "Reports",
      icon: "chart",
      path: "/dashboard/franchise-owner/reports",
    },
    {
      label: "Settings",
      icon: "settings",
      path: "/dashboard/franchise-owner/settings",
    },
  ],
};
